...
def characters():
    ...
    return {"characters": [
        {"name": character.name, "level": character.level, "hp": character.hp, "atk": character.atk,
         ...
         "talent_na": character.talent_na, "talent_burst": character.talent_burst, "talent_skill": character.talent_skill, "friendship_lvl": character.friendship_lvl,
         "dmg_bonus_type": character.dmg_bonus_type, "dmg_bonus_val": character.dmg_bonus_val, "artifacts": [{"slot": artifact.slot,
